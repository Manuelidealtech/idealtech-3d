...
export default async function AdminDashboard() {
  let products = demoProducts.length, shares = 0, views = 0;
  if (isSupabaseConfigured) {
    ...
    if (db) {
      ...
      products = pc || 0; shares = sc || 0; views = vc || 0;
    }
  }
  return <>
    ...
    {!isSupabaseConfigured && <div className="setupNotice"><strong>Modalità demo attiva</strong><p>L'interfaccia è pronta. Dopo la configurazione di Supabase questa dashboard userà dati reali.</p></div>}
